...
exports.ConnectionPool = exports.MultiAltEndpointsConnectionFactory = exports.MultiAltEndpointsConnection = exports.ConnectionFactory = exports.Connection = exports.DefaultEventHandler = exports.Event = void 0;
...
class MultiAltEndpointsConnectionFactory {
    constructor(pickEndpoint) {
        this._pickEndpoint = pickEndpoint;
    }
    create(options, eventHandler) {
        return new MultiAltEndpointsConnection(this._pickEndpoint, options, eventHandler);
    }
}
exports.MultiAltEndpointsConnectionFactory = MultiAltEndpointsConnectionFactory;
class ConnectionPool extends internal_1.Listenable {
    constructor(connectionFactory, options, eventHandler = new DefaultEventHandler()) {
        super();
        this._id = ++ID_SEED;
