...
exports.Connection = exports.Options = exports.Code = exports.Event = void 0;
...
class Connection extends internal_1.Listenable {
    ...
    _onClose() {
        console.log(`Connection disconnected: endpoint: ${this._currentEndpoint()}`);
    ...
    _onError(e) {
        console.error(`Failed to connect: endpoint: ${this._currentEndpoint()}, error: ${e.message}`);
